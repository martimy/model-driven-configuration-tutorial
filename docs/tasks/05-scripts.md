...
In addition to `netconf-console2` and `gnmic`, we can use Python scripts to interact with the routers. These scripts could simplify some complex tasks and ultimately help automate the network configuration.
